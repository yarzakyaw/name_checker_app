...
class MyanmarReferencesWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final List<String> consonantNotes = [
      ...
      "\"သှ\" မှာ သံပြင်း သ သံကို ညွှန်းခြင်းဖြစ်ပြီး သ အက္ခရာအောက်က အကောက်ကလေး ထည့်ရေးသားခြင်း ဖြစ်ပါသည်။",
    ];
    ...
    final List<String> vowelNotes = [
      ...
      "ရ ကို r ဟု သတ်မှတ်ထားသော်လည်း ယ သံ ထွက်သည့် ရ ကို y ဖြင့် စာလုံးပေါင်းပါသည်။",
      "မွန် ကို Mon ဟု စာလုံးပေါင်းပါသည်။",
